...
def _patch_admin_notes_suppression_final():
    ...
    def note_card_final(self, n, reload):
        ...
        try:
            ...
            card.add_widget(make_label(contenu, size=13, h=130))
        ...
        if statut == "demande_suppression":
            try:
                ...
                b1 = make_btn("ACCEPTER SUPPR.", bg=(0.50, 0.05, 0.05, 1), h=44)
                b2 = make_btn("REFUSER SUPPR.", bg=(0, 0.45, 0.05, 1), h=44)
