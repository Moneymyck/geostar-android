...
def _build_ui_with_licence(self):
    ...
    # Lancer la vérification après plusieurs délais pour être sûr
    Clock.schedule_once(lambda dt: _geostar_licence_startup_check(), 0.5)
    Clock.schedule_once(lambda dt: _geostar_force_activation_check(), 1.5)
    Clock.schedule_once(lambda dt: _geostar_force_activation_check(), 3.0)
