    ...
    def popup_solutions_final(self):
        ...
        def make_combo():
            ...
            for idx,it in enumerate(combos,1):
                ...
                b.bind(on_release=lambda x,item=it:_open_results(self,item)); bg.bind(on_release=lambda x,item=it:_open_results(self,item)); bd.bind(on_release=lambda x,item=it:(_remove_combo(item), switch(None)))
