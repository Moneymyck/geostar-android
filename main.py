                            ...
                            def open_audio(btn, url=audio):
                                try:
                                    ...
                                    try:
                                        ...
                                        message(self, "Audio", "Impossible d’ouvrir le vocal : " + str(e)[:250])
...
def _geostar_recherche_avancee_unique_patch():
    ...
    def popup_recherche_avancee(self):
        ...
        box.add_widget(Label(text="4. Type", color=(0.9,0.9,0.9,1), size_hint=(1,None), height=dp(24)))
        type_row = GridLayout(cols=3, spacing=dp(4), size_hint=(1,None), height=dp(42))
        b_auto = ToggleButton(text="AUTO", group="adv_type", state="down", font_size=dp(10), background_color=(0.20,0.35,0.55,1))
        b_rep = ToggleButton(text="RÉPÉTITION", group="adv_type", font_size=dp(10), background_color=(0.28,0.15,0.45,1))
        b_fig = ToggleButton(text="FIGURE", group="adv_type", font_size=dp(10), background_color=(0.10,0.45,0.25,1))
        b_auto.bind(on_press=lambda x: selected_type.__setitem__(0, "auto"))
        b_rep.bind(on_press=lambda x: selected_type.__setitem__(0, "repetition"))
        b_fig.bind(on_press=lambda x: selected_type.__setitem__(0, "figure"))
        type_row.add_widget(b_auto); type_row.add_widget(b_rep); type_row.add_widget(b_fig)
        box.add_widget(type_row)

        info = Label(
            text="STRICTE = seulement les maisons choisies. NON STRICTE = les maisons choisies + possible ailleurs. Sans maisons = recherche globale.",
            color=(0.75,0.75,0.75,1), size_hint=(1,None), height=dp(54), font_size=dp(10)
        )
        box.add_widget(info)
